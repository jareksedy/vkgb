...
struct NewsDataStorage {
    static var news: [News] = [
        News(id: 0, userId: 8, text: "Повесься, ты пожалеешь об этом; не повесься, ты и об этом пожалеешь, в том и другом случае ты пожалеешь об этом. Таково, милостивые государи, резюме всей жизненной мудрости."),
