...
struct News {
    ...
    init(id: Int, userId: Int, text: String, imageName: String? = nil) {
        ...
        self.text = text
        self.imageName = imageName ?? "defaultNewsImage"
    }
}
...
struct NewsDataStorage {
    static var news: [News] = [
        ...
        News(id: 2, userId: 4, text: "Депрессия подобна даме в черном. Если она пришла, не гони ее прочь, а пригласи к столу как гостью и послушай то, о чем она намерена сказать."),
        ...
        News(id: 7, userId: 1, text: "Кто сражается с чудовищами, тому следует остерегаться, чтобы самому при этом не стать чудовищем. И если ты долго смотришь в бездну, то бездна тоже смотрит в тебя."),
