...
struct NewsDataStorage {
    static var news: [News] = [
        ...
        News(id: 1, userId: 9, text: "Культурный человек возможность счастья променял на гарантированную безопасность.", likesCount: Int.random(in: 9...99), likedByMe: false, viewsCount: Int.random(in: 99...9999)),
